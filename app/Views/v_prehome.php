...
<body>
    <div class="container mt-4">
        <div id="map" style="width: 104%; height: 660px; margin-top: -25px; margin-left: -23px;"></div>
    </div>
    ...
    <script>
        ...
        <?php foreach ($kodam as $key => $value) { ?>
           ...
           <h6 class="popup-title"><?= $value['nama_kodam'] ?></h6>
            <div class="popup-content">
                ...
                <a class="btn btn-info btn-detail" href="<?= base_url('PreHomeKodam/DetailKodam/' . $value['id']) ?>">Detail</a>
            </div>
        </div>`
                )
                .addTo(map);
        ...
        <?php foreach ($lantamal as $key => $value) { ?>
           ...
           <div class="popup-content">
                ...
                <a class="btn btn-info btn-detail" href="<?= base_url('PreHomeLantamal/DetailLantamal/' . $value['id']) ?>">Detail</a>
            </div>
        </div>
        `)
                .addTo(map);
        ...
        <?php foreach ($koopsud as $key => $value) { ?>
           ...
           <h6 class="popup-title"><?= $value['nama_koopsud'] ?></h6>
            <div class="popup-content">
                ...
                <a class="btn btn-info btn-detail" href="<?= base_url('PreHomeKoopsud/DetailKoopsud/' . $value['id']) ?>">Detail</a>
            </div>
        </div>
        `)
                .addTo(map);
