    ...
    <div class="col-md-12" style="margin-top: 10px;">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart('Koopsud/Update/' . $koopsud['id']) ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="nama_amunisi" value="<?= $koopsud['nama_amunisi'] ?>" placeholder="Masukkan Nama Amunisi 1" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="jml_amunisi" value="<?= $koopsud['jml_amunisi'] ?>" placeholder="Masukkan Jumlah Amunisi 1" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_amunisi" placeholder="Masukkan Deskripsi Amunisi 1" class="form-control"><?= $koopsud['deskripsi_amunisi'] ?></textarea>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="nama_amunisi_2" value="<?= $koopsud['nama_amunisi_2'] ?>" placeholder="Masukkan Nama Amunisi 2" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="jml_amunisi_2" value="<?= $koopsud['jml_amunisi_2'] ?>" placeholder="Masukkan Jumlah Amunisi 2" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_amunisi_2" placeholder="Masukkan Deskripsi Amunisi 2" class="form-control"><?= $koopsud['deskripsi_amunisi_2'] ?></textarea>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="nama_pertahanan_udara" value="<?= $koopsud['nama_pertahanan_udara'] ?>" placeholder="Masukkan Nama Pertahanan Udara 1" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="jml_pertahanan_udara" value="<?= $koopsud['jml_pertahanan_udara'] ?>" placeholder="Masukkan Jumlah Pertahanan Udara 1" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_pertahanan_udara" placeholder="Masukkan Deskripsi Pertahanan Udara 1" class="form-control"><?= $koopsud['deskripsi_pertahanan_udara'] ?></textarea>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="nama_pertahanan_udara_2" value="<?= $koopsud['nama_pertahanan_udara_2'] ?>" placeholder="Masukkan Nama Pertahanan Udara 2" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="jml_pertahanan_udara_2" value="<?= $koopsud['jml_pertahanan_udara_2'] ?>" placeholder="Masukkan Jumlah Pertahanan Udara 2" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_pertahanan_udara_2" placeholder="Masukkan Deskripsi Pertahanan Udara 2" class="form-control"><?= $koopsud['deskripsi_pertahanan_udara_2'] ?></textarea>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="nama_pesawat_terbang" value="<?= $koopsud['nama_pesawat_terbang'] ?>" placeholder="Masukkan Nama Pesawat Terbang 1" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="jml_pesawat_terbang" value="<?= $koopsud['jml_pesawat_terbang'] ?>" placeholder="Masukkan Jumlah Pesawat Terbang 1" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_pesawat_terbang" placeholder="Masukkan Deskripsi Pesawat Terbang 1" class="form-control"><?= $koopsud['deskripsi_pesawat_terbang'] ?></textarea>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="nama_pesawat_terbang_2" value="<?= $koopsud['nama_pesawat_terbang_2'] ?>" placeholder="Masukkan Nama Pesawat Terbang 2" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="jml_pesawat_terbang_2" value="<?= $koopsud['jml_pesawat_terbang_2'] ?>" placeholder="Masukkan Jumlah Pesawat Terbang 2" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_pesawat_terbang_2" placeholder="Masukkan Deskripsi Pesawat Terbang 2" class="form-control"><?= $koopsud['deskripsi_pesawat_terbang_2'] ?></textarea>
