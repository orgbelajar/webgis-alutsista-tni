<div class="container mt-4">
    ...
    <div class="text-center mb-4">
        <img src="<?= base_url('Gambar/Lantamal/Logo/' . $lantamal['foto']) ?>" alt="Foto Koopsud" class="img-fluid" style="max-height: 301px;">
    </div>
        ...
        <div class="card-body">
            ...
            <div class="row mb-4">
                <div class="col-md-6 text-center mb-3">
                    <img src="<?= base_url('Gambar/Lantamal/Artileri/' . $lantamal['foto_artileri']) ?>" alt="Artileri 1" class="img-fluid" style="height: 350px; width: 550px;">
                ...
                <div class="col-md-6 text-center mb-3">
                    <img src="<?= base_url('Gambar/Lantamal/Artileri 2/' . $lantamal['foto_artileri_2']) ?>" alt="Artileri 2" class="img-fluid" style="height: 350px; width: 550px;">
            ...
            <div class="row mb-4">
                <div class="col-md-6 text-center mb-3">
                    <img src="<?= base_url('Gambar/Lantamal/Kapal Selam/' . $lantamal['foto_armada_kapal_selam']) ?>" alt="Kapal Selam 1" class="img-fluid" style="height: 350px; width: 550px;">
                ...
                <div class="col-md-6 text-center mb-3">
                    <img src="<?= base_url('Gambar/Lantamal/Kapal Selam 2/' . $lantamal['foto_armada_kapal_selam_2']) ?>" alt="Kapal Selam 2" class="img-fluid" style="height: 350px; width: 550px;">
            ...
            <div class="row mb-4">
                <div class="col-md-6 text-center mb-3">
                    <img src="<?= base_url('Gambar/Lantamal/Kapal Permukaan/' . $lantamal['foto_armada_kapal_permukaan']) ?>" alt="Kapal Permukaan 1" class="img-fluid" style="height: 350px; width: 550px;">
                ...
                <div class="col-md-6 text-center mb-3">
                    <img src="<?= base_url('Gambar/Lantamal/Kapal Permukaan 2/' . $lantamal['foto_armada_kapal_permukaan_2']) ?>" alt="Kapal Permukaan 2" class="img-fluid" style="height: 350px; width: 550px;">
