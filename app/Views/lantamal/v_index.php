                    ...
                    foreach ($lantamal as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('Lantamal/Detail/' . $value['id']) ?>" class="btn btn-xs btn-success btn-flat"><i class="fas fa-eye"></i></a>
                                <a href="<?= base_url('Lantamal/Edit/' . $value['id']) ?>" class="btn btn-xs btn-warning btn-flat"><i class="fas fa-pencil-alt"></i></a>
                                <a href="<?= base_url('Lantamal/Delete/' . $value['id']) ?>" onclick="return confirm('Ingin Hapus Data <?= $value['nama_lantamal'] ?>?')" class="btn btn-xs btn-danger btn-flat"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
