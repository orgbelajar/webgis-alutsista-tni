            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input name="alamat" value="<?= old('alamat') ?>" placeholder="Masukkan Alamat Lantamal" class="form-control" required>
                        <p class="text-danger"><?= isset($errors['nama_lantamal']) ? $errors['nama_lantamal'] : '' ?></p>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <p class="text-danger"><?= isset($errors['jml_personil']) ? $errors['jml_personil'] : '' ?></p>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input name="deskripsi_armada_kapal_selam" value="<?= old('deskripsi_armada_kapal_selam') ?>" placeholder="Masukkan Deskripsi Kapal Selam 1" class="form-control" required>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="file" accept=".png" name="foto_armada_kapal_selam" class="form-control" required>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input name="deskripsi_armada_kapal_selam_2" value="<?= old('deskripsi_armada_kapal_selam_2') ?>" placeholder="Masukkan Deskripsi Kapal Selam 2" class="form-control" required>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <label>Foto Kapal Selam 2</label>
                        <input type="file" accept=".png" name="foto_armada_kapal_selam_2" class="form-control" required>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input name="deskripsi_artileri" value="<?= old('deskripsi_artileri') ?>" placeholder="Masukkan Deskripsi Artileri 1" class="form-control" required>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input name="deskripsi_artileri_2" value="<?= old('deskripsi_artileri_2') ?>" placeholder="Masukkan Deskripsi Artileri 2" class="form-control" required>
                        <p class="text-danger"><?= isset($errors['deskripsi_alutsista_artileri_2']) ? $errors['deskripsi_alutsista_artileri_2'] : '' ?></p>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input name="deskripsi_armada_kapal_permukaan" value="<?= old('deskripsi_armada_kapal_permukaan') ?>" placeholder="Masukkan Deskripsi Kapal Permukaan 1" class="form-control" required>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <label>Foto Kapal Permukaan 1</label>
                        <input type="file" accept=".png" name="foto_armada_kapal_permukaan" class="form-control" required>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input name="deskripsi_armada_kapal_permukaan_2" value="<?= old('deskripsi_armada_kapal_permukaan_2') ?>" placeholder="Masukkan Deskripsi Kapal Permukaan 2" class="form-control" required>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <label>Foto Kapal Permukaan 2</label>
                        <input type="file" accept=".png" name="foto_armada_kapal_permukaan_2" class="form-control" required>
