    ...
    <div class="col-md-12" style="margin-top: 10px;">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart('Kodam/Update/' . $kodam['id']) ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="nama_artileri" value="<?= $kodam['nama_artileri'] ?>" placeholder="Masukkan Nama Artileri 1" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="jml_artileri" value="<?= $kodam['jml_artileri'] ?>" placeholder="Masukkan Jumlah Artileri 1" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_artileri" placeholder="Masukkan Deskripsi Artileri 1" class="form-control"><?= $kodam['deskripsi_artileri'] ?></textarea>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="nama_artileri_2" value="<?= $kodam['nama_artileri_2'] ?>" placeholder="Masukkan Nama Artileri 2" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="jml_artileri_2" value="<?= $kodam['jml_artileri_2'] ?>" placeholder="Masukkan Jumlah Artileri 2" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_artileri_2" placeholder="Masukkan Deskripsi Artileri 2" class="form-control"><?= $kodam['deskripsi_artileri_2'] ?></textarea>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="nama_tank" value="<?= $kodam['nama_tank'] ?>" placeholder="Masukkan Nama Tank 1" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="jml_tank" value="<?= $kodam['jml_tank'] ?>" placeholder="Masukkan Jumlah Tank 1" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_tank" placeholder="Masukkan Deskripsi Tank 1" class="form-control"><?= $kodam['deskripsi_tank'] ?></textarea>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="nama_tank_2" value="<?= $kodam['nama_tank_2'] ?>" placeholder="Masukkan Nama Tank 2" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="jml_tank_2" value="<?= $kodam['jml_tank_2'] ?>" placeholder="Masukkan Jumlah Tank 2" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_tank_2" placeholder="Masukkan Deskripsi Tank 2" class="form-control"><?= $kodam['deskripsi_tank_2'] ?></textarea>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="nama_helikopter" value="<?= $kodam['nama_helikopter'] ?>" placeholder="Masukkan Nama Helikopter 1" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="jml_helikopter" value="<?= $kodam['jml_helikopter'] ?>" placeholder="Masukkan Jumlah Helikopter 1" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_helikopter" placeholder="Masukkan Deskripsi Helikopter 1" class="form-control"><?= $kodam['deskripsi_helikopter'] ?></textarea>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="nama_helikopter_2" value="<?= $kodam['nama_helikopter_2'] ?>" placeholder="Masukkan Nama Helikopter 2" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="jml_helikopter_2" value="<?= $kodam['jml_helikopter_2'] ?>" placeholder="Masukkan Jumlah Helikopter 2" class="form-control">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_helikopter_2" placeholder="Masukkan Deskripsi Helikopter 2" class="form-control"><?= $kodam['deskripsi_helikopter_2'] ?></textarea>
