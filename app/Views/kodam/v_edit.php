...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        ...
        <!-- <p>ID kodam: <? //= $kodam['id'] 
                            ?></p>
        <pre><? //php print_r($kodam); 
                ?></pre> -->

        <?php echo form_open_multipart('Kodam/UpdateData/' . $kodam['id']) ?>


        <input type="hidden" name="id" value="<?= $kodam['id'] ?>">

        <div class="row">
            <div class="col-sm-3">
                <div class="form-group">
                    <label>Nama Kodam</label>
                    <input name="nama_kodam" value="<?= $kodam['nama_kodam'] ?>" placeholder="Nama Kodam" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="date" name="tgl_dibentuk" value="<?= $kodam['tgl_dibentuk'] ?>" placeholder="Tanggal Didirikan" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <select name="id_wilayah" class="form-control" required>
                        ...
                        <?php foreach ($wilayah as $key => $value) { ?>
                            <option value="<?= $value['id'] ?>" <?= ($value['id'] == $kodam['id_wilayah']) ? 'selected' : '' ?>>
                                <?= $value['nama_wilayah'] ?>
                            </option>
                        <?php } ?>
                    </select>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input name="koordinat" id="Koordinat" value="<?= $kodam['koordinat'] ?>" placeholder="Latitude, Longitude" class="form-control" required>
        ...
        <div class="row">
                    ...
                    <select name="id_kesatuan" class="form-control" required>
                        ...
                        <?php foreach ($kesatuan as $key => $value) { ?>
                            <?php if ($value['kesatuan'] == 'TNI AD') { ?>
                                <option value="<?= $value['id'] ?>" <?= $kodam['id_kesatuan'] == $value['id'] ? 'selected' : '' ?>>
                                    <?= $value['kesatuan'] ?>
                                </option>
                            <?php } ?>
                        <?php } ?>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="number" name="jml_personel" value="<?= $kodam['jml_personel'] ?>" placeholder="Masukkan Jumlah Personel" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    <label>Alamat Kodam</label>
                    <textarea name="alamat" placeholder="Masukkan Alamat Kodam" class="form-control" required><?= $kodam['alamat'] ?></textarea>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input name="nama_artileri" value="<?= $kodam['nama_artileri'] ?>" placeholder="Masukkan Nama Artileri 1" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="number" name="jml_artileri" value="<?= $kodam['jml_artileri'] ?>" placeholder="Masukkan Jumlah Artileri 1" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <textarea name="deskripsi_artileri" placeholder="Masukkan Deskripsi Artileri 1" class="form-control" required><?= $kodam['deskripsi_artileri'] ?></textarea>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input name="nama_artileri_2" value="<?= $kodam['nama_artileri_2'] ?>" placeholder="Masukkan Nama Artileri 2" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="number" name="jml_artileri_2" value="<?= $kodam['jml_artileri_2'] ?>" placeholder="Masukkan Jumlah Artileri 2" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <textarea name="deskripsi_artileri_2" placeholder="Masukkan Deskripsi Artileri 2" class="form-control" required><?= $kodam['deskripsi_artileri_2'] ?></textarea>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input name="nama_tank" value="<?= $kodam['nama_tank'] ?>" placeholder="Masukkan Nama Tank 1" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="number" name="jml_tank" value="<?= $kodam['jml_tank'] ?>" placeholder="Masukkan Jumlah Tank 1" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <textarea name="deskripsi_tank" placeholder="Masukkan Deskripsi Tank 1" class="form-control" required><?= $kodam['deskripsi_tank'] ?></textarea>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input name="nama_tank_2" value="<?= $kodam['nama_tank_2'] ?>" placeholder="Masukkan Nama Tank 2" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="number" name="jml_tank_2" value="<?= $kodam['jml_tank_2'] ?>" placeholder="Masukkan Jumlah Tank 2" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <textarea name="deskripsi_tank_2" placeholder="Masukkan Deskripsi Tank 2" class="form-control" required><?= $kodam['deskripsi_tank_2'] ?></textarea>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input name="nama_helikopter" value="<?= $kodam['nama_helikopter'] ?>" placeholder="Masukkan Nama Helikopter 1" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="number" name="jml_helikopter" value="<?= $kodam['jml_helikopter'] ?>" placeholder="Masukkan Jumlah Helikopter 1" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <textarea name="deskripsi_helikopter" placeholder="Masukkan Deskripsi Helikopter 1" class="form-control" required><?= $kodam['deskripsi_helikopter'] ?></textarea>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input name="nama_helikopter_2" value="<?= $kodam['nama_helikopter_2'] ?>" placeholder="Masukkan Nama Helikopter 2" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input type="number" name="jml_helikopter_2" value="<?= $kodam['jml_helikopter_2'] ?>" placeholder="Masukkan Jumlah Helikopter 2" class="form-control" required>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <textarea name="deskripsi_helikopter_2" placeholder="Masukkan Deskripsi Helikopter 2" class="form-control" required><?= $kodam['deskripsi_helikopter_2'] ?></textarea>
        ...
        <div class="d-flex justify-content-end mt-2">
            ...
            <a href="<?= base_url('Kodam') ?>" class="btn btn-success btn-flat ml-2">Kembali</a>
        </div>
...
<script>
    ...
    var curLocation = [<?= $kodam['koordinat'] ?>];
