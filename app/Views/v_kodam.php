    ...
    <div class="card-header">
      ...
      <script>
        ...
        const marker1 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam_iskandar_muda.png',
        ...
        const marker2 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam_1.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
        ...
        const marker3 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam_2.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
        ...
        const marker4 = L.icon({
          iconUrl: 'http://localhost:8080/marker/Lambang_Kodam_Jaya.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
        ...
        const marker5 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam_3.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
        ...
        const marker6 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam_4.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
        ...
        const marker7 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam_5.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
        ...
        const marker8 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam_9.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
        ...
        const marker9 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam-6.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
        ...
        const marker10 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam_12.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
        ...
        const marker11 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam_13.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
        ...
        const marker12 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam_14.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
        ...
        const marker13 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam_15.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
        ...
        const marker14 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam-17.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
        ...
        const marker15 = L.icon({
          iconUrl: 'http://localhost:8080/marker/kodam_18.png',
          iconSize: [30, 35], // size of the icon
        });
        // Tambahkan marker ke peta
