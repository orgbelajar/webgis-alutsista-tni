<div class="col-md-12">
            <div class="card card-outline card-primary">
              ...
              ?>
              <?php echo form_open_multipart('Batalyon/InsertData') ?>

              <div class="row">
                <div class="col-sm-6">
                <div class="form-group">
                <label>Nama Batalyon</label>
                <input name="nama_batalyon" value="<?= old('nama_batalyon') ?>" placeholder="Nama Batalyon" class="form-control">
                ...
                <input name="thn_dibentuk" value="<?= old('thn_dibentuk') ?>" placeholder="Tahun dibentuk" class="form-control">
                ...
                <select name="id_komando" class="form-control">
                  ...
                  <?php foreach ($komando as $key => $value) { ?>
                    <option value="<?= $value['id_komando'] ?>"><?= $value['komando'] ?></option>
                  <?php } ?>
              ...
              <div class="form-group">
                ...
                <input name="coordinate" id="Coordinate" value="<?= old('coordinate') ?>" placeholder="Coordinate Batalyon" class="form-control" readonly>
                ...
                <div class="form-group">
                <label>Alamat</label>
                <input name="alamat" value="<?= old('alamat') ?>" placeholder="Alamat Batalyon" class="form-control">
