  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input name="koordinat" id="Koordinat" value="<?= old('koordinat') ?>" placeholder="Koordinat Kodam" class="form-control" required>
        <p class="text-danger"><?= isset($errors['nama_kodam']) ? $errors['nama_kodam'] : '' ?></p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input name="alamat" value="<?= old('alamat') ?>" placeholder="Alamat Kodam" class="form-control" required>
            <p class="text-danger"><?= isset($errors['nama_kodam']) ? $errors['nama_kodam'] : '' ?></p>
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="number" name="jml_kendaraan_tempur" value="<?= old('jml_kendaraan_tempur') ?>" placeholder="Masukkan Jumlah Kendaraan Tempur" class="form-control" required>
            <p class="text-danger"><?= isset($errors['nama_kodam']) ? $errors['nama_kodam'] : '' ?></p>
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="number" name="jml_helikopter" value="<?= old('jml_helikopter') ?>" placeholder="Masukkan Jumlah Helikopter" class="form-control" required>
            <p class="text-danger"><?= isset($errors['nama_kodam']) ? $errors['nama_kodam'] : '' ?></p>
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="number" name="jml_pertahanan_udara" value="<?= old('jml_pertahanan_udara') ?>" placeholder="Masukkan Jumlah Pertahanan Udara" class="form-control" required>
            <p class="text-danger"><?= isset($errors['nama_kodam']) ? $errors['nama_kodam'] : '' ?></p>
          </div>
        </div>
      </div>
