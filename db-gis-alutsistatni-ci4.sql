...
--
-- Host: localhost:3306
-- Generation Time: Apr 26, 2025 at 05:03 AM
...
CREATE TABLE `tbl_batalyon` (
  `id_batalyon` int NOT NULL,
  `id_komando` int DEFAULT NULL,
  `nama_batalyon` varchar(150) DEFAULT NULL,
  `thn_dibentuk` date DEFAULT NULL,
  `cabang` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `coordinate` varchar(150) DEFAULT NULL,
...
INSERT INTO `tbl_batalyon` (`id_batalyon`, `id_komando`, `nama_batalyon`, `thn_dibentuk`, `cabang`, `coordinate`, `foto`, `alamat`, `id_provinsi`, `id_kabupaten`, `id_kecamatan`, `id_wilayah`) VALUES
(1, 1, 'Batalyon Kavaleri 1', '1950-04-15', 'Kavaleri', '-6.315912188653794, 106.85422580760677', 'Batalyon_Kav_1.png', 'Jl. RA. Fadillah No.9 1, RT.2/RW.5, Cijantung', 31, 3172, 3172010, 5),
(2, 1, 'Batalyon Kavaleri 7', '1962-07-23', 'Kavaleri', '-6.328323673542781, 106.84492880677209', 'Batalyon_Kav_7.png', 'Jl. Yonkav 7 No.7, RT.1/RW.6, Cijantung', 31, 3173, 3172010, 5),
(7, 1, 'batalyon 5', '2025-05-20', 'Infanteri', '-6.35897532723566,106.83105468750001', '1745225477_480e0bb1db18b8be4973.png', 'jalanindah', 31, 3173, 3173060, 3),
(8, 1, 'test', '0000-00-00', 'Kavaleri', '-1.318243056862001,112.10449218750001', '1745466537_b99b99b9de0efe8d7509.jpg', 'test', 11, 1102, 1102010, 2),
(9, 2, 'Test', '0000-00-00', 'Infanteri', '-6.035407759648527,106.0565185546875', '1745501970_e1454380e830dfa9d209.jpg', 'test', 36, 3601, 3601010, 1);
...
--
-- Table structure for table `tbl_kesatuan`
--

CREATE TABLE `tbl_kesatuan` (
  `id` int NOT NULL,
  `kesatuan` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `marker` varchar(150) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_kesatuan`
--

INSERT INTO `tbl_kesatuan` (`id`, `kesatuan`, `marker`) VALUES
(1, 'TNI AD', '1743240049_4fe7d821bc35d6c86b03.png'),
(2, 'TNI AL', 'Lambang_TNI_AL.png'),
(3, 'TNI AU', 'Lambang_TNI_AU.png');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_kodam`
--

CREATE TABLE `tbl_kodam` (
  `id` int NOT NULL,
  `id_kesatuan` int DEFAULT NULL,
  `nama_kodam` varchar(200) DEFAULT NULL,
  `tgl_dibentuk` int DEFAULT NULL,
  `jml_personil` int DEFAULT NULL,
  `jml_kendaraan_tempur` int DEFAULT NULL,
  `jml_artileri` int DEFAULT NULL,
  `jml_helikopter` int DEFAULT NULL,
  `jml_pertahanan_udara` int DEFAULT NULL,
...
CREATE TABLE `tbl_setting` (
  ...
  `coordinate_wilayah` varchar(255) DEFAULT NULL,
...
INSERT INTO `tbl_setting` (`id`, `nama_web`, `coordinate_wilayah`, `zoom_view`) VALUES
(1, 'WEB GIS ALUTSISTA TNI', '-2.2331, 117.2841', 5);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_tniad`
--

CREATE TABLE `tbl_tniad` (
  `id_kodam` int NOT NULL,
  `personil` int NOT NULL,
  `alutsista` varchar(255) NOT NULL,
  `amunisi` int NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `tbl_tnial`
--

CREATE TABLE `tbl_tnial` (
  `id_lantamal` int NOT NULL,
  `personil` int NOT NULL,
  `alutsista` int NOT NULL,
  `amunisi` int NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `tbl_tniau`
--

CREATE TABLE `tbl_tniau` (
  `id_koopsud` int NOT NULL,
  `personil` int NOT NULL,
  `alutsista` int NOT NULL,
  `amunisi` int NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
(1, 'GIS AlutsistaTNI', 'admin@gmail.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'logotni.jpeg'),
(2, 'Monero', 'monero@gmail.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'monero.png'),
(3, 'Certik', 'certik@gmail.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', '1744976817_2d7d0ed0d48bc7a2ba11.png');
...
INSERT INTO `tbl_wilayah` (`id`, `nama_wilayah`, `geojson`, `warna`) VALUES
(1, 'Kecamatan Gambir   ', '{\r\n  \"type\": \"FeatureCollection\",\r\n  \"features\": [\r\n    {\r\n      \"type\": \"Feature\",\r\n      \"geometry\": {\r\n        \"type\": \"Polygon\",\r\n        \"coordinates\": [\r\n          [\r\n            [106.83278, -6.175964],\r\n            [106.834222, -6.1748],\r\n            [106.835087, -6.178461],\r\n            [106.836759, -6.178971],\r\n            [106.835116, -6.180475],\r\n            [106.836615, -6.18161],\r\n            [106.834625, -6.182405],\r\n            [106.830617, -6.182916],\r\n            [106.823263, -6.183483],\r\n            [106.821677, -6.18337],\r\n            [106.816803, -6.181979],\r\n            [106.814467, -6.181724],\r\n            [106.810372, -6.185015],\r\n            [106.810112, -6.182717],\r\n            [106.809853, -6.179709],\r\n            [106.805469, -6.173438],\r\n            [106.800509, -6.166202],\r\n            [106.800394, -6.166004],\r\n            [106.798231, -6.16135],\r\n            [106.800163, -6.160471],\r\n            [106.801288, -6.158825],\r\n            [106.801403, -6.157236],\r\n            [106.801634, -6.160187],\r\n            [106.803912, -6.161804],\r\n            [106.808094, -6.161379],\r\n            [106.811006, -6.160783],\r\n            [106.812794, -6.160669],\r\n            [106.819052, -6.159676],\r\n            [106.820667, -6.159563],\r\n            [106.828512, -6.162627],\r\n            [106.830155, -6.164897],\r\n            [106.830473, -6.168075],\r\n            [106.829492, -6.17097],\r\n            [106.830011, -6.173013],\r\n            [106.831424, -6.172275],\r\n            [106.83301, -6.172587],\r\n            [106.832088, -6.175651],\r\n            [106.83278, -6.175964]\r\n          ]\r\n        ]\r\n      },\r\n      \"properties\": {\r\n        \"name\": \"GAMBIR\"\r\n      }\r\n    }\r\n  ]\r\n}', '#000000'),
(2, 'Kecamatan Sawah Besar', '{\r\n  \"type\": \"FeatureCollection\",\r\n  \"features\": [\r\n    {\r\n      \"type\": \"Feature\",\r\n      \"geometry\": {\r\n        \"type\": \"Polygon\",\r\n        \"coordinates\": [\r\n          [\r\n            [106.837365, -6.159137],\r\n            [106.840422, -6.171055],\r\n            [106.840797, -6.171821],\r\n            [106.838922, -6.17375],\r\n            [106.836327, -6.175651],\r\n            [106.834423, -6.172899],\r\n            [106.832751, -6.174715],\r\n            [106.83278, -6.175964],\r\n            [106.832088, -6.175651],\r\n            [106.83301, -6.172587],\r\n            [106.831424, -6.172275],\r\n            [106.830011, -6.173013],\r\n            [106.829492, -6.17097],\r\n            [106.830473, -6.168075],\r\n            [106.830155, -6.164897],\r\n            [106.828512, -6.162627],\r\n            [106.827473, -6.15979],\r\n            [106.827444, -6.159392],\r\n            [106.827156, -6.15122],\r\n            [106.826637, -6.148468],\r\n            [106.825801, -6.145829],\r\n            [106.823926, -6.142736],\r\n            [106.821273, -6.136834],\r\n            [106.830703, -6.13533],\r\n            [106.830588, -6.139246],\r\n            [106.832116, -6.141459],\r\n            [106.833356, -6.141686],\r\n            [106.83601, -6.143332],\r\n            [106.83725, -6.144807],\r\n            [106.838317, -6.141771],\r\n            [106.84394, -6.144949],\r\n            [106.84146, -6.148922],\r\n            [106.840999, -6.152213],\r\n            [106.839816, -6.153944],\r\n            [106.840797, -6.158144],\r\n            [106.837365, -6.159137]\r\n          ]\r\n        ]\r\n      },\r\n      \"properties\": {\r\n        \"name\": \"SAWAH BESAR\"\r\n      }\r\n    }\r\n  ]\r\n}', '#f50713'),
(3, 'Kecamatan Kemayoran', '{\r\n  \"type\": \"FeatureCollection\",\r\n  \"features\": [\r\n    {\r\n      \"type\": \"Feature\",\r\n      \"geometry\": {\r\n        \"type\": \"Polygon\",\r\n        \"coordinates\": [\r\n          [\r\n            [106.8489, -6.16816],\r\n            [106.843536, -6.168586],\r\n            [106.843652, -6.170175],\r\n            [106.84296, -6.171594],\r\n            [106.840797, -6.171821],\r\n            [106.840422, -6.171055],\r\n            [106.837365, -6.159137],\r\n            [106.840797, -6.158144],\r\n            [106.839816, -6.153944],\r\n            [106.840999, -6.152213],\r\n            [106.84146, -6.148922],\r\n            [106.84394, -6.144949],\r\n            [106.84717, -6.146936],\r\n            [106.849621, -6.149035],\r\n            [106.850371, -6.152809],\r\n            [106.856168, -6.152213],\r\n            [106.856802, -6.151646],\r\n            [106.858706, -6.152724],\r\n            [106.860349, -6.152611],\r\n            [106.861186, -6.151419],\r\n            [106.860205, -6.153717],\r\n            [106.866953, -6.157548],\r\n            [106.874192, -6.161662],\r\n            [106.876961, -6.163478],\r\n            [106.881921, -6.162599],\r\n            [106.878893, -6.166288],\r\n            [106.876413, -6.166174],\r\n            [106.871077, -6.168104],\r\n            [106.865252, -6.170941],\r\n            [106.860724, -6.173069],\r\n            [106.857581, -6.173892],\r\n            [106.852159, -6.174516],\r\n            [106.852448, -6.16904],\r\n            [106.849304, -6.168728],\r\n            [106.8489, -6.16816]\r\n          ]\r\n        ]\r\n      },\r\n      \"properties\": {\r\n        \"name\": \"KEMAYORAN\"\r\n      }\r\n    }\r\n  ]\r\n}', '#07f527'),
(4, ' Kecamatan Cempaka Putih', '{\r\n  \"type\": \"FeatureCollection\",\r\n  \"features\": [\r\n    {\r\n      \"type\": \"Feature\",\r\n      \"geometry\": {\r\n        \"type\": \"Polygon\",\r\n        \"coordinates\": [\r\n          [\r\n                [106.863752, -6.188052],\r\n                [106.862483, -6.18564],\r\n                [106.861532, -6.18127],\r\n                [106.859917, -6.18127],\r\n                [106.858879, -6.17795],\r\n                [106.857581, -6.173892],\r\n                [106.860724, -6.173069],\r\n                [106.865252, -6.170941],\r\n                [106.871077, -6.168104],\r\n                [106.876413, -6.166174],\r\n                [106.878893, -6.166288],\r\n                [106.878835, -6.166429],\r\n                [106.878085, -6.168132],\r\n                [106.876067, -6.176191],\r\n                [106.875403, -6.18825],\r\n                [106.875374, -6.188761],\r\n                [106.875374, -6.189924],\r\n                [106.87722, -6.192393],\r\n                [106.875028, -6.192393],\r\n                [106.872779, -6.191996],\r\n                [106.865685, -6.19262],\r\n                [106.86306, -6.193386],\r\n                [106.860638, -6.194833],\r\n                [106.858504, -6.196309],\r\n                [106.85536, -6.192194],\r\n                [106.859801, -6.189357],\r\n                [106.863752, -6.188052]\r\n          ]\r\n        ]\r\n      },\r\n      \"properties\": {\r\n        \"name\": \"CEMPAKA PUTIH\"\r\n      }\r\n    }\r\n  ]\r\n}\r\n', '#0CF9D7'),
(5, ' Kecamatan Pasar Rebo', '{\r\n  \"type\": \"FeatureCollection\",\r\n  \"features\": [\r\n    {\r\n      \"type\": \"Feature\",\r\n      \"geometry\": {\r\n        \"type\": \"Polygon\",\r\n        \"coordinates\": [\r\n          [\r\n                        [\r\n                            106.859513,\r\n                            -6.292246\r\n                        ],\r\n                        [\r\n                            106.860378,\r\n                            -6.293977\r\n                        ],\r\n                        [\r\n                            106.86231,\r\n                            -6.29375\r\n                        ],\r\n                        [\r\n                            106.862743,\r\n                            -6.294857\r\n                        ],\r\n                        [\r\n                            106.865281,\r\n                            -6.294573\r\n                        ],\r\n                        [\r\n                            106.86554,\r\n                            -6.297978\r\n                        ],\r\n                        [\r\n                            106.866723,\r\n                            -6.29917\r\n                        ],\r\n                        [\r\n                            106.869462,\r\n                            -6.300305\r\n                        ],\r\n                        [\r\n                            106.867127,\r\n                            -6.303086\r\n                        ],\r\n                        [\r\n                            106.862772,\r\n                            -6.31035\r\n                        ],\r\n                        [\r\n                            106.862541,\r\n                            -6.311428\r\n                        ],\r\n                        [\r\n                            106.863031,\r\n                            -6.314322\r\n                        ],\r\n                        [\r\n                            106.864935,\r\n                            -6.319316\r\n                        ],\r\n                        [\r\n                            106.864964,\r\n                            -6.322182\r\n                        ],\r\n                        [\r\n                            106.863839,\r\n                            -6.325928\r\n                        ],\r\n                        [\r\n                            106.864445,\r\n                            -6.327971\r\n                        ],\r\n                        [\r\n                            106.866752,\r\n                            -6.330383\r\n                        ],\r\n                        [\r\n                            106.867617,\r\n                            -6.332653\r\n                        ],\r\n                        [\r\n                            106.868395,\r\n                            -6.337647\r\n                        ],\r\n                        [\r\n                            106.871135,\r\n                            -6.338356\r\n                        ],\r\n                        [\r\n                            106.87275,\r\n                            -6.339548\r\n                        ],\r\n                        [\r\n                            106.871481,\r\n                            -6.340371\r\n                        ],\r\n                        [\r\n                            106.872346,\r\n                            -6.341875\r\n                        ],\r\n                        [\r\n                            106.872029,\r\n                            -6.343067\r\n                        ],\r\n                        [\r\n                            106.873183,\r\n                            -6.343492\r\n                        ],\r\n                        [\r\n                            106.871654,\r\n                            -6.345705\r\n                        ],\r\n                        [\r\n                            106.869982,\r\n                            -6.346273\r\n                        ],\r\n                        [\r\n                            106.868857,\r\n                            -6.348259\r\n                        ],\r\n                        [\r\n                            106.868165,\r\n                            -6.35348\r\n                        ],\r\n                        [\r\n                            106.867847,\r\n                            -6.354502\r\n                        ],\r\n                        [\r\n                            106.863579,\r\n                            -6.356318\r\n                        ],\r\n                        [\r\n                            106.862599,\r\n                            -6.354814\r\n                        ],\r\n                        [\r\n                            106.860955,\r\n                            -6.354275\r\n                        ],\r\n                        [\r\n                            106.856254,\r\n                            -6.353792\r\n                        ],\r\n                        [\r\n                            106.856745,\r\n                            -6.351012\r\n                        ],\r\n                        [\r\n                            106.857812,\r\n                            -6.348117\r\n                        ],\r\n                        [\r\n                            106.855274,\r\n                            -6.346557\r\n                        ],\r\n                        [\r\n                            106.855591,\r\n                            -6.344003\r\n                        ],\r\n                        [\r\n                            106.855072,\r\n                            -6.342329\r\n                        ],\r\n                        [\r\n                            106.851727,\r\n                            -6.341478\r\n                        ],\r\n                        [\r\n                            106.850141,\r\n                            -6.340343\r\n                        ],\r\n                        [\r\n                            106.850429,\r\n                            -6.339264\r\n                        ],\r\n                        [\r\n                            106.848266,\r\n                            -6.338158\r\n                        ],\r\n                        [\r\n                            106.848727,\r\n                            -6.337023\r\n                        ],\r\n                        [\r\n                            106.844027,\r\n                            -6.337391\r\n                        ],\r\n                        [\r\n                            106.843796,\r\n                            -6.336285\r\n                        ],\r\n                        [\r\n                            106.83973,\r\n                            -6.33515\r\n                        ],\r\n                        [\r\n                            106.840162,\r\n                            -6.332227\r\n                        ],\r\n                        [\r\n                            106.842585,\r\n                            -6.332199\r\n                        ],\r\n                        [\r\n                            106.843075,\r\n                            -6.331234\r\n                        ],\r\n                        [\r\n                            106.840508,\r\n                            -6.329787\r\n                        ],\r\n                        [\r\n                            106.84097,\r\n                            -6.327318\r\n                        ],\r\n                        [\r\n                            106.843248,\r\n                            -6.326751\r\n                        ],\r\n                        [\r\n                            106.841633,\r\n                            -6.323658\r\n                        ],\r\n                        [\r\n                            106.838374,\r\n                            -6.321047\r\n                        ],\r\n                        [\r\n                            106.840105,\r\n                            -6.31855\r\n                        ],\r\n                        [\r\n                            106.844084,\r\n                            -6.31821\r\n                        ],\r\n                        [\r\n                            106.844084,\r\n                            -6.316763\r\n                        ],\r\n                        [\r\n                            106.845988,\r\n                            -6.317046\r\n                        ],\r\n                        [\r\n                            106.848353,\r\n                            -6.31506\r\n                        ],\r\n                        [\r\n                            106.848958,\r\n                            -6.315514\r\n                        ],\r\n                        [\r\n                            106.847949,\r\n                            -6.318323\r\n                        ],\r\n                        [\r\n                            106.849131,\r\n                            -6.318834\r\n                        ],\r\n                        [\r\n                            106.849477,\r\n                            -6.317585\r\n                        ],\r\n                        [\r\n                            106.851582,\r\n                            -6.316394\r\n                        ],\r\n                        [\r\n                            106.851265,\r\n                            -6.314322\r\n                        ],\r\n                        [\r\n                            106.852794,\r\n                            -6.310974\r\n                        ],\r\n                        [\r\n                            106.855793,\r\n                            -6.31367\r\n                        ],\r\n                        [\r\n                            106.858013,\r\n                            -6.311712\r\n                        ],\r\n                        [\r\n                            106.856831,\r\n                            -6.310265\r\n                        ],\r\n                        [\r\n                            106.858417,\r\n                            -6.305157\r\n                        ],\r\n                        [\r\n                            106.855303,\r\n                            -6.303738\r\n                        ],\r\n                        [\r\n                            106.854409,\r\n                            -6.302603\r\n                        ],\r\n                        [\r\n                            106.855072,\r\n                            -6.30127\r\n                        ],\r\n                        [\r\n                            106.854668,\r\n                            -6.299453\r\n                        ],\r\n                        [\r\n                            106.853255,\r\n                            -6.299851\r\n                        ],\r\n                        [\r\n                            106.85239,\r\n                            -6.298404\r\n                        ],\r\n                        [\r\n                            106.850429,\r\n                            -6.296588\r\n                        ],\r\n                        [\r\n                            106.850804,\r\n                            -6.295821\r\n                        ],\r\n                        [\r\n                            106.854409,\r\n                            -6.296105\r\n                        ],\r\n                        [\r\n                            106.854322,\r\n                            -6.293977\r\n                        ],\r\n                        [\r\n                            106.855822,\r\n                            -6.294403\r\n                        ],\r\n                        [\r\n                            106.855764,\r\n                            -6.292757\r\n                        ],\r\n                        [\r\n                            106.859513,\r\n                            -6.292246\r\n                        ]\r\n          ]\r\n        ]\r\n      },\r\n      \"properties\": {\r\n        \"name\": \"PASAR REBO\"\r\n      }\r\n    }\r\n  ]\r\n}', '#FF06FF'),
(6, ' Kecamatan Senen', '{\r\n  \"type\": \"FeatureCollection\",\r\n  \"features\": [\r\n    {\r\n      \"type\": \"Feature\",\r\n      \"geometry\": {\r\n        \"type\": \"Polygon\",\r\n        \"coordinates\": [\r\n          [\r\n                [106.83699, -6.181809],\r\n                [106.836615, -6.18161],\r\n                [106.835116, -6.180475],\r\n                [106.836759, -6.178971],\r\n                [106.835087, -6.178461],\r\n                [106.834222, -6.1748],\r\n                [106.83278, -6.175964],\r\n                [106.832751, -6.174715],\r\n                [106.834423, -6.172899],\r\n                [106.836327, -6.175651],\r\n                [106.838922, -6.17375],\r\n                [106.840797, -6.171821],\r\n                [106.84296, -6.171594],\r\n                [106.843652, -6.170175],\r\n                [106.843536, -6.168586],\r\n                [106.8489, -6.16816],\r\n                [106.849304, -6.168728],\r\n                [106.852448, -6.16904],\r\n                [106.852159, -6.174516],\r\n                [106.851813, -6.174545],\r\n                [106.845498, -6.174942],\r\n                [106.845094, -6.175197],\r\n                [106.845151, -6.175424],\r\n                [106.846882, -6.180844],\r\n                [106.851179, -6.186576],\r\n                [106.851438, -6.186349],\r\n                [106.851554, -6.187371],\r\n                [106.85536, -6.192194],\r\n                [106.858504, -6.196309],\r\n                [106.853861, -6.199487],\r\n                [106.851035, -6.201587],\r\n                [106.848987, -6.198891],\r\n                [106.847747, -6.19838],\r\n                [106.846334, -6.199288],\r\n                [106.845036, -6.198579],\r\n                [106.845642, -6.195912],\r\n                [106.843825, -6.195486],\r\n                [106.843623, -6.193897],\r\n                [106.845296, -6.192393],\r\n                [106.840941, -6.18913],\r\n                [106.841229, -6.187484],\r\n                [106.840739, -6.187172],\r\n                [106.840364, -6.185413],\r\n                [106.838172, -6.186065],\r\n                [106.836067, -6.184334],\r\n                [106.83699, -6.181809]\r\n          ]\r\n        ]\r\n      },\r\n      \"properties\": {\r\n        \"name\": \"SENEN\"\r\n      }\r\n    }\r\n  ]\r\n}', '#E9F506');
...
--
-- Indexes for table `tbl_kesatuan`
--
ALTER TABLE `tbl_kesatuan`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_kodam`
--
ALTER TABLE `tbl_kodam`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `tbl_batalyon`
  MODIFY `id_batalyon` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tbl_kesatuan`
--
ALTER TABLE `tbl_kesatuan`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_kodam`
--
ALTER TABLE `tbl_kodam`
